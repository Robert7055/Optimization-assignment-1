...
\midrule
Total Cost & 2.75 & DKK \\
Import Cost & 0.00 & DKK \\
Export Revenue & 11.22 & DKK \\
Net Energy Cost & -11.22 & DKK \\
Discomfort Cost & 13.97 & DKK \\
\midrule
Total PV Production & 6.90 & kWh \\
Total PV Curtailment & 0.00 & kWh \\
Total Grid Import & 0.00 & kWh \\
Total Grid Export & 6.90 & kWh \\
Total Load & 0.00 & kWh \\
Reference Load & 27.95 & kWh \\
Load Deviation & -27.95 & kWh \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{itemize}[noitemsep]
    \item Hours with curtailment: 0 out of 24
    \item Mean dual (when curtailing): N/A DKK/kWh
...
\begin{itemize}[noitemsep]
    \item Hours with load $>$ reference: 0
    \item Hours with load $<$ reference: 24
    \item Hours at reference: 0
...
\midrule
Base price (DKK/kWh) & 1.01 & 1.1 & 1.5 \\
PV production (kW) & 0.15 & 0.75 & 0.15 \\
Reference load (kW) & 1.44 & 1.05 & 2.7 \\
Optimal load (kW) & 0.0 & 0.0 & 0.0 \\
Grid import (kW) & 0.0 & 0.0 & 0.0 \\
Grid export (kW) & 0.42 & 2.55 & 0.75 \\
Shadow price (DKK/kWh) & 0.61 & 0.7 & 1.1 \\
\bottomrule
\end{tabular}
\end{table}
...
Shadow price (DKK/kWh) & 0.61 & 0.7 & 1.1 \\
\midrule
Max WTP (DKK/kWh) & 1.9 & 0.8 & 1.8 \\
Theoretical WTP & 1.05 & 0.85 & 1.85 \\
Min MOC (DKK/kWh) & 2.8 & 1.8 & 2.8 \\
Theoretical MOC & 1.95 & 1.75 & 2.75 \\
\midrule
Base case action & SELF & SELF & SELF \\
\bottomrule
\end{tabular}
\end{table}
